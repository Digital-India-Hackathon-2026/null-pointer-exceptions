import { FaTractor, FaWheelchair, FaFemale, FaHeartbeat, FaUserGraduate, FaBriefcase, FaHandsHelping, FaUsers } from "react-icons/fa";
...
const CATEGORY_META = {
  ...
  senior: { label: "For Senior Citizens", icon: <FaUsers />, color: "#7C3AED" },
  employee: { label: "For Employees & Labor", icon: <FaBriefcase />, color: "#2563EB" }
};
