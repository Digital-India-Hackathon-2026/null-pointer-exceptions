...
export default function ProfileForm({ isSelf, initialData, onSubmit, onCancel }) {
    ...
    <div className="card">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="link-btn-row">
          ...
          <button className="btn btn-primary" type="submit" style={{ flex: 2 }}>Check Eligible Schemes</button>
        </div>
      </form>
    </div>
  );
